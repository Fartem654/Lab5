...
import static ru.fadeev.Animal.ExtrMeow.doMew;
import static ru.fadeev.Competition.AnalyzeFile.show3Best;
import static ru.fadeev.Lists.MergeList.listInList;
import static ru.fadeev.Stream.Stream.formPerson;
import static ru.fadeev.Stream.Stream.formPolyline;
import static ru.fadeev.Stream.geometry.InputPoint.createListPoint;
...
import static ru.fadeev.UserPanel.CheckInput.inputListIntUp;
import static ru.fadeev.UserPanel.CheckInput.inputListString;

import java.util.List;
import java.util.Queue;
import ru.fadeev.Animal.Cat;
import ru.fadeev.Animal.Interface.Meowable;
import ru.fadeev.Animal.MeowCount;
import ru.fadeev.Mathem.CacheFraction;
import ru.fadeev.Mathem.Interfaces.FractionInterface;
import ru.fadeev.Queue.QueueElem;
